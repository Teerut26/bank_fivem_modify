...
$('#close').click(function () {
    ...
    $.post('http://7K_bank/NUIFocusOff', JSON.stringify({}));
});

$('#withdraw').click(function (e) {
    e.preventDefault();
    $.post('http://7K_bank/withdrawl', JSON.stringify({
...
$('#deposit').click(function (e) {
    e.preventDefault();
    $.post('http://7K_bank/deposit', JSON.stringify({
...
$('#transfer').click(function (e) {
    e.preventDefault();
    $.post('http://7K_bank/transfer', JSON.stringify({
        to: $('#idval').val(),
